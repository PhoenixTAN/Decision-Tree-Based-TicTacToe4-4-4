...
public class runTicTacToe {
	 ...
	 * @author TF in CS 640 at Boston University
	 * @return List<List<positionTicTacToe>>
	 * Function: 
	...
	private int isEnded() {
		...
		for( int i = 0;i < board.size();i++ ) {
			// state = 0 means this position is unmarked.
